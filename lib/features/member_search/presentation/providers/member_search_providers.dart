...
final memberSearchUnameProvider =
    Provider.family<String?, String>((ref, mid) => null);

/// Provider for MemberSearchChildControllerV2 (archive type)
final memberSearchArchiveChildProvider = Provider.family<
    MemberSearchChildControllerV2, String>((ref, mid) {
...
final memberSearchDynamicChildProvider = Provider.family<
    MemberSearchChildControllerV2, String>((ref, mid) {
  final parent = ref.watch(memberSearchControllerProvider(mid));
