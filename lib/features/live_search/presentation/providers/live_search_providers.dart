...
final liveSearchRoomChildProvider = Provider.family<
    LiveSearchChildControllerV2, ({String? mid, String? uname})>((ref, args) {
...
final liveSearchUserChildProvider = Provider.family<
    LiveSearchChildControllerV2, ({String? mid, String? uname})>((ref, args) {
  final parent = ref.watch(liveSearchControllerProvider(args));
