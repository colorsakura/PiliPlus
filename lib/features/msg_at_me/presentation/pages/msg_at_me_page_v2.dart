...
/// @Me notifications page - V2 with Riverpod
...
class _MsgAtMePageV2State extends ConsumerState<MsgAtMePageV2> {
  late final MsgAtMeController _controller;

  @override
  void initState() {
    super.initState();
    _controller = ref.read(msgAtMeControllerProvider);
  }
            ...
            ? SliverList.separated(
                ...
                itemBuilder: (context, int index) {
                  ...
                  void onLongPress() => showConfirmDialog(
                    context: context,
                    title: '确定删除该通知?',
                    onConfirm: () => _controller.removeItem(item.id!, index),
                  );
                  return ListTile(
                    safeArea: true,
                    onTap: () {
