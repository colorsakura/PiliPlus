...
class _HistoryPageState extends ConsumerState<HistoryPage> {
  ...
  late final HistoryMultiSelectController _multiSelectController;

  @override
  void initState() {
    super.initState();
    _multiSelectController = HistoryMultiSelectController();
  }
        ...
        child: CustomScrollView(
          ...
          slivers: [
            SliverPadding(
              ...
              sliver: _buildBody(state, gridDelegate, widget.type),
            ),
          ],
        ),
      ),
  ...
  Widget _buildBody(HistoryState state, gridDelegate, String? type) {
