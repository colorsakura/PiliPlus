...
/// 热门视频远程数据源 Provider
final hotVideoRemoteDataSourceProvider = Provider<HotVideoRemoteDataSource>((
  ref,
) {
...
/// 热门视频仓库 Provider
final hotVideoRepositoryProvider = Provider<HotVideoRepositoryImpl>((ref) {
...
/// 获取热门视频用例 Provider
final fetchHotVideosUseCaseProvider = Provider<FetchHotVideosUseCase>((ref) {
