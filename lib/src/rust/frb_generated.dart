...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -383225387;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<BiliCursor> crateApiCommentsBiliCursorDefault();
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<BiliCursor> crateApiCommentsBiliCursorDefault() {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_bili_cursor,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiCommentsBiliCursorDefaultConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiCommentsBiliCursorDefaultConstMeta =>
      const TaskConstMeta(
        debugName: "bili_cursor_default",
        argNames: [],
      );
  ...
  @protected
  BiliCursor dco_decode_bili_cursor(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return BiliCursor(
      isEnd: dco_decode_bool(arr[0]),
      next: dco_decode_opt_String(arr[1]),
      prev: dco_decode_opt_String(arr[2]),
    );
  }
  ...
  @protected
  BiliCursor sse_decode_bili_cursor(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    return BiliCursor(isEnd: var_isEnd, next: var_next, prev: var_prev);
  }
  ...
  @protected
  void sse_encode_bili_cursor(BiliCursor self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
